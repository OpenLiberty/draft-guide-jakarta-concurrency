...
// file 2
SystemResource.java
[source,xml,linenums,role="code_column hide_tags=copyright,schedule,schedulToggle,sse"]
----
...
After 5 seconds, you'll see the latest system load data at the first row of the table.
