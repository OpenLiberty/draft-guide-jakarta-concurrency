...
**NOTE:** Leave the `system` microservice to run. In the following sections, you'll implement the `inventory` microservice to learn how to create parallel or asynchronous tasks.
