...
Annotate the [hotspot=asynchronous1 file=0]`getSystemLoad()` method with the `@Asynchronous` annotation to make it running asynchronously.
...
The latest system load data will be displayed at the first row of the table after 5 seconds.
